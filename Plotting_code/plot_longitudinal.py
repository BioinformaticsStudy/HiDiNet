...
RMSE_sort_missing[:,1] = RMSE_missing_mdiin/RMSE_pop_missing
...
RMSE_sort_notmissing[:,1] = RMSE_notmissing_mdiin/RMSE_pop_notmissing
...
ax.errorbar(np.arange(N)+1, RMSE_sort_missing[:,1], marker = '*',color = cm(4),markersize = 6, linestyle = '', label = 'MDiiN', zorder= 10000000)
# ax.errorbar(np.arange(N)+1, RMSE_sort_missing[:,5], marker = 'o',color = cm(0),markersize = 6, linestyle = '', label = 'DJIN', zorder= 10000000-1)
...
ax.errorbar(np.arange(N)+1, RMSE_sort_notmissing[:,1], marker = '*',color = cm(4),markersize = 6, linestyle = '', label = 'MDiiN', zorder= 10000000)
# ax.errorbar(np.arange(N)+1, RMSE_sort_notmissing[:,5], marker = 'o',color = cm(0),markersize = 6, linestyle = '', label = 'DJIN', zorder= 10000000-1)
