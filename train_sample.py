...
pop_avg = np.load('Data/Population_averages_sample.npy')
pop_avg_env = np.load('Data/Population_averages_env_sample.npy')
pop_std = np.load('Data/Population_std_sample.npy')
...
valid_name = 'Data/valid_sample.csv'
